...
Riemannian Geometric Generation via Epistemic Graphs

![](assets/logo_light.png#only-light)
![](assets/logo_dark.png#only-dark)
...
#### <center>[Repository (private)](https://jingyu.tplinkdns.com/gitea/Experiment/rivae)</center>

The MNIST dataset in latent space:

![](assets/mnist_latent_space.png)

[**Interactive Visualization**](assets/mnist_latent_space.html)
...
![](assets/mnist_latent_space_manifold.png)

[**Interactive Visualization**](assets/mnist_latent_space_manifold.html)
...
![](assets/mnist_latent_space_trajectory.png)

[**Interactive Visualization**](assets/mnist_latent_space_trajectory.html)

| Start | End | Transition |
|-------|-----| -----------|
| ![](assets/mnist_trajectory_start.png){ width="300" } | ![](assets/mnist_trajectory_end.png){ width="300" } | ![](assets/mnist_trajectory.gif){ width="300" } |
